...
@pytest.mark.asyncio
@patch("routers.chat.root_client.send")
@patch("routers.chat.llama_client.apply_template")
@patch("routers.chat.llama_client.tokenize")
@patch("routers.chat.slot_manager.allocate_and_prepare_slot")
async def test_chat_completions_non_stream(
    mock_allocate, mock_tokenize, mock_apply, mock_send, test_client
):
